...
test_start() { echo ""; echo ">>> 测试 $1: $2"; TESTS_TOTAL=$((TESTS_TOTAL + 1)); }
test_pass()  { echo "    [通过] $1"; TESTS_PASSED=$((TESTS_PASSED + 1)); }
test_fail()  { echo "    [失败] $1"; echo "    原因: $2"; TESTS_FAILED=$((TESTS_FAILED + 1)); }
