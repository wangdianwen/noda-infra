    ...
    <hudson.model.ParametersDefinitionProperty>
      <parameterDefinitions>
        <hudson.model.ChoiceParameterDefinition>
          <name>SERVICE</name>
          <description>选择要部署的基础设施服务；*-static = 构建静态站并 mc mirror 入桶（与 Jenkinsfile.infra parameters 块保持一致）</description>
          <choices class="java.util.Arrays$ArrayList">
            <a class="string-array">
              ...
              <string>class-static</string>
              <string>www-static</string>
              <string>admin-static</string>
              <string>liuyao-static</string>
              <string>nearby-static</string>
              <string>auth-static</string>
